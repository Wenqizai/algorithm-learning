...
public class P02MaxSubArray {
    public static void main(String[] args) {
        ...
        System.out.println(divideMaxSubArrayNum(arr, 0, arr.length - 1));
    }
     ...
     * 2. 计算左边最大值
     * 3. 计算右边最大值
     * 4. 计算中间最大值, 中间最大值 = 左边最大子数组 + 右边最大子数组
     * <p>
     * 比如计算数组: [-2, 1]
     * 1. 二分数组 [-2] [1]
     * 2. 计算左边最大值 -2
     * 3. 计算右边最大值 1
     * 4. 计算中间最大值 -2 + 1 = -1
     * 相当于一次递归同时计算数组: [-2], [1], [-2, 1]
     */
    private static int divideMaxSubArrayNum(int[] nums, int left, int right) {
        if (left == right) {
            return nums[left];
        }
        int mid = (left + right) / 2;
        int leftMaxSum = divideMaxSubArrayNum(nums, left, mid);
        int rightMaxSum = divideMaxSubArrayNum(nums, mid + 1, right);
